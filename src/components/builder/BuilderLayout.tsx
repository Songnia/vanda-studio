    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
        ...
        <div className="max-w-6xl mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="font-bold text-lg leading-tight">PhotoStudio Builder</h1>
                <p className="text-xs text-gray-500">Créez votre site de photographe</p>
              </div>
            </div>
      ...
      <footer className="bg-white border-t py-4">
        <div className="max-w-6xl mx-auto px-4 text-center text-sm text-gray-500">
          PhotoStudio Builder - Créez un site professionnel pour votre activité photo
        </div>
      </footer>
    </div>
  );
