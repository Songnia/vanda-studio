        ...
        >
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            <span className={`text-sm ${isYearly ? 'text-white' : 'text-gray-400'}`}>
              Annuel
              <Badge className="ml-2 bg-green-500/20 text-green-400 border-0">-17%</Badge>
            </span>
          </div>
        </motion.div>
            ...
            >
              {plan.popular && (
                <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                  <Badge className="bg-green-500 text-black font-semibold px-3 py-1">
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a]">
      {/* Progress Bar */}
      <motion.div
        className="fixed top-0 left-0 right-0 h-0.5 bg-green-500 origin-left z-[60]"
        style={{ scaleX }}
      />
